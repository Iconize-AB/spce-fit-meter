      ...
      questions: [
        ...
        },
        {
          ...
          options: [
            ...
            { label: "Simple or Standard products", value: "simple", score: 0 },
            { label: "Technical products", value: "technical", score: 50 },
            { label: "Configurable products", value: "configurable", score: 100 },
            { label: "Customer unique", value: "unique", score: 100 },
            { label: "Services", value: "services", score: 50 },
          ],
        },
        {
      ...
      questions: [
        ...
        },
        {
          ...
          options: [
            ...
            { label: "Sharepoint/Onedrive", value: "sharepoint", score: 50 },
            { label: "We have need but no solution", value: "no_solution", score: 100 },
            { label: "DAM/PIM System", value: "dam_pim", score: 0 },
        ...
        },
        {
          ...
          options: [
            ...
            { label: "Need and share videos (Youtube etc.)", value: "videos", score: 50 },
            { label: "Learning Management System w. issues", value: "lms_issues", score: 100 },
        ...
        },
        {
          ...
          options: [
            ...
            { label: "No need", value: "no_need", score: 0 },
            { label: "Need but no solution", value: "no_solution", score: 100 },
            { label: "Excel spreadsheets from/to partners", value: "excel", score: 50 },
